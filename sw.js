...
const FICHEIROS_ESSENCIAIS = ['./', './index.html', './manifest.json', './icon-192.png', './icon-512.png', './vendor/supabase.js', './vendor/supabase.js', './vendor/supabase.js', './storefront-phase1.js', './storefront-phase1.css', './vendor/supabase.js', './vendor/supabase.js'];
